...
def displayValuesInLCDLoop(listData):
    ...
    sleep(2)
    systemLCD.lcd_clear()
    systemLCD.lcd_display_string_pos(str("DHT Temp: " + listData[2] + " C"), 1,1)
    systemLCD.lcd_display_string_pos(str("DHT Hum: " + listData[3] + " %"), 2,1)
    sleep(2)
    systemLCD.lcd_clear()
    systemLCD.lcd_display_string_pos(str("DHT HI: " + listData[2]), 1,1)
    systemLCD.lcd_display_string_pos(str("BMP Temp: " + listData[3] + " C"), 2,1)
    sleep(5)
    systemLCD.lcd_clear()
    systemLCD.lcd_display_string_pos(str("BMP Pres: " + listData[2] + " Bar"), 1,1)
    systemLCD.lcd_display_string_pos(str("BMP Alt: " + listData[3] + " m"), 2,1)
    sleep(2)
