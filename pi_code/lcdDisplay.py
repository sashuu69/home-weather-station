...
def displayValuesInLCDLoop(listData):
    ...
    sleep(2)
    systemLCD.lcd_clear()
    systemLCD.lcd_display_string_pos(str("DHT Temp: " + listData[6] + " C"), 1,1)
    systemLCD.lcd_display_string_pos(str("DHT Hum: " + listData[7] + " %"), 2,1)
    sleep(2)
    systemLCD.lcd_clear()
    systemLCD.lcd_display_string_pos(str("DHT HI: " + listData[8]), 1,1)
    systemLCD.lcd_display_string_pos(str("BMP Temp: " + listData[9] + " C"), 2,1)
    sleep(5)
    systemLCD.lcd_clear()
    systemLCD.lcd_display_string_pos(str("BMP Pres: " + listData[10] + " Bar"), 1,1)
    systemLCD.lcd_display_string_pos(str("BMP Alt: " + listData[11] + " m"), 2,1)
    sleep(2)
