...
def displayValuesInLCDLoop(listData):
    ...
    sleep(2)
    systemLCD.lcd_clear()
    systemLCD.lcd_display_string_pos(str("D Temp: " + listData[6] + " C"), 1,1)
    systemLCD.lcd_display_string_pos(str("D Hum: " + listData[7] + " %"), 2,1)
    sleep(2)
    systemLCD.lcd_clear()
    systemLCD.lcd_display_string_pos(str("D HI: " + listData[8]), 1,1)
